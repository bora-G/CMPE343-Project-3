...
public class OwnerController implements Initializable {
    ...
    private void setupAllOrdersTable() {
        ...
        allCustomerColumn.setCellValueFactory(cellData -> {
            try {
                com.group17.greengrocer.model.User customer = ownerService
        ...
        allCarrierColumn.setCellValueFactory(cellData -> {
            try {
                if (cellData.getValue().getCarrierId() != null) {
                    com.group17.greengrocer.model.User carrier = ownerService
    ...
    private void loadLoyaltyStandards() {
        ...
        java.math.BigDecimal discountPercent = com.group17.greengrocer.service.LoyaltyService
            ...
            if (buttonType == ButtonType.OK) {
                ...
                try {
                    ...
                    int customerId = selected instanceof String ? -1
                            : ((com.group17.greengrocer.model.User) selected).getUserId();
    ...
    private void handleAdjustLoyalty() {
        ...
        TextField thresholdField = new TextField(
                String.valueOf(com.group17.greengrocer.service.LoyaltyService.getLoyaltyThreshold()));
        thresholdField.setPromptText("Minimum completed orders (e.g., 5)");

        TextField discountPercentField = new TextField(
                String.valueOf(com.group17.greengrocer.service.LoyaltyService.getLoyaltyDiscountPercent()));
        ...
        content.getChildren().addAll(
                ...
                new Label("Threshold: " + com.group17.greengrocer.service.LoyaltyService.getLoyaltyThreshold()
                        + " orders"),
