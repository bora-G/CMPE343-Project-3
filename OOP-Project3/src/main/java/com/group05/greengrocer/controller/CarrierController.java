...
public class CarrierController implements Initializable {
    ...
    private void setupTables() {
        ...
        completeColumn.setCellFactory(param -> new TableCell<Order, Void>() {
            ...
            {
                completeButton.setPrefWidth(95);
                completeButton.setMinWidth(95);
                cancelButton.setPrefWidth(95);
                cancelButton.setMinWidth(95);
    ...
    private void handleViewOrderDetails(Order order) {
        try {
            ...
            for (com.group05.greengrocer.model.OrderItem item : fullOrder.getItems()) {
